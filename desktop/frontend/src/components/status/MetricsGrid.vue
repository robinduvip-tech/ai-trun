  ...
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 select-none">
    ...
    <div class="bg-glass bg-glass-hover rounded-xl p-4.5 border border-white/[0.03] flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-muted-foreground uppercase">网关端口</span>
    ...
    <div class="bg-glass bg-glass-hover rounded-xl p-4.5 border border-white/[0.03] flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-muted-foreground uppercase">运行时长</span>
    ...
    <div class="bg-glass bg-glass-hover rounded-xl p-4.5 border border-white/[0.03] flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-muted-foreground uppercase">调度信道</span>
    ...
    <div class="bg-glass bg-glass-hover rounded-xl p-4.5 border border-white/[0.03] flex flex-col justify-between group">
      <div class="flex items-center justify-between">
        <span class="text-[11px] font-bold tracking-wider text-muted-foreground uppercase">网关版本</span>
        <div class="p-1.5 rounded-lg bg-card/40 border border-border/20 group-hover:bg-card/60 transition-colors">
      ...
      <div class="mt-4 flex items-baseline gap-1.5 min-w-0">
        ...
        <span class="text-[9px] text-muted-foreground font-medium shrink-0">
          stable
        </span>
      </div>
    </div>
